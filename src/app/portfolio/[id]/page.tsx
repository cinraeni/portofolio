...
const staticProjects = [
  {
    ...
    image_urls: [
      '/assets/homi.png',
      '/assets/HOMI/Dashboard (1).png',
      '/assets/HOMI/Form Ajuan 12.png',
      '/assets/HOMI/Proses Pengaduan 1.png',
      '/assets/HOMI/Riwayat 1.png'
    ],
    technologies: 'Laravel 12.x, MySQL, Kotlin, Jetpack Compose, Jetpack DataStore, Animated AppNavHost, Redis, Firebase Cloud Messaging, Database-per-Tenant Isolation',
    key_features: 'Interactive Onboarding, Smart Billing (QRIS), Portal Dokumen (PDF), Tenancy Control, Automated Reminders (WhatsApp), Announcement Master, OCR Automasi Pembayaran, PDF Engine (Puppeteer)',
    live_url: '',
    github_url: 'https://github.com/farrel1234/homi-project.git',
  },
  {
    id: 'lumina',
    ...
    image_urls: [
      '/assets/Lumina.png',
      '/assets/Lumina/Android Compact - 1 (1).png',
      '/assets/Lumina/Android Compact - 16.png',
      '/assets/Lumina/Android Compact - 5 (2).png',
      '/assets/Lumina/Android Compact - 52.png',
      '/assets/Lumina/Android Compact - 6.png'
    ],
    technologies: 'Kotlin, Jetpack Compose (Material 3), MVVM, Kotlin Coroutines, Jetpack Navigation Compose, Retrofit, OkHttp3, Gson, OSMDroid, Google Play Services Location, CameraX, Coil, Gradle (Kotlin DSL)',
    key_features: 'Smart Image Detection / Processing, Interactive Map & Location Picker, Sistem Pelaporan Terpadu, Autentikasi & Keamanan Akun, Riwayat & Detail Laporan, Modern & Responsive UI',
    live_url: '',
    github_url: 'https://github.com/dyrexya/Lumina.git',
  },
  {
    id: 'verdant',
    ...
    image_urls: ['/assets/verdant.png'],
    technologies: 'Kotlin, Android Studio, Firebase Authentication, Firebase Realtime Database, Google Maps API, Retrofit, Material Design 3',
    key_features: 'Sistem Booking Otomatis, E-Ticket System dengan QR Code, Integrasi Peta Destinasi Wisata, Review & Rating Tempat Wisata, Notifikasi Promo & Diskon, Manajemen Profil Wisatawan',
    live_url: '',
    github_url: '',
  },
  {
    ...
    key_features: 'Visualisasi Data Interaktif, Dashboard Analitik, Manajemen Data Internasional, Export Report',
    live_url: '',
    github_url: '',
  },
  {
    ...
    image_url: '',
    image_urls: [],
    technologies: 'Figma, HTML, CSS, JavaScript, PHP',
    key_features: 'Pencatatan Pemasukan & Pengeluaran, Perencanaan Anggaran Bulanan, Grafik Laporan Keuangan, Export Data Keuangan',
    live_url: '',
    github_url: '',
  },
]
  ...
  const fetchProject = async () => {
    try {
      ...
      // Supabase failed, use static data
    }
